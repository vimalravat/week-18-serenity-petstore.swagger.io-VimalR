package io.swagger.petstore.CURDTestWithSteps;

import io.restassured.response.Response;
import io.restassured.response.ValidatableResponse;
import io.swagger.petstore.model.PetPojo;
import io.swagger.petstore.studentinfo.PetSteps;
...
public class PetCURDTestWithSteps extends TestBase {
    ...
    public void test001() {
        ...
        ValidatableResponse response = petSteps.createStudent(id, tags, status, categoryList, name);
